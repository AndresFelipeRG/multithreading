package com.multithreading.multithreading.service;
...
import com.multithreading.multithreading.dao.repository.CarRepository;
...
public class CarService {
    ...
    public CompletableFuture<List<Car>> saveCars(final InputStream inputStream) throws Exception {
        ...
        cars = ((JpaRepository<Car, Long>) carRepository).saveAll(cars);
    ...
    public CompletableFuture<List<Car>> getAllCars() {
        ...
        final List<Car> cars = ((JpaRepository<Car, Long>) carRepository).findAll();
        return CompletableFuture.completedFuture(cars);
    }
}